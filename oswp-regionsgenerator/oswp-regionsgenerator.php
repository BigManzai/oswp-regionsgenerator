<?php
/**
 * WordPress Widget oswp-regionsgenerator
 *
 * 
 *
 * @package   Widget_oswp-regionsgenerator
 ...
 * Domain Path:       /lang
 * GitHub Plugin URI: https://github.com/BigManzai/oswp-regionsgenerator
 */
...
class oswp_regionsgenerator extends WP_Widget {
    ...
    /**
     * @TODO - Rename "oswp-regionsgenerator" to the name your your widget
     *
     ...
     * @var      string
     */
    protected $widget_slug = 'oswp-regionsgenerator';
	...
	public function __construct() {
		...
		parent::__construct(
			...
			__( 'oswp-regionsgenerator', $this->get_widget_slug() ),
			array(
	...
	public function widget( $args, $instance ) {
		...
		ob_start();
		include( plugin_dir_path( __FILE__ ) . 'views/regionsgenerator-widget.php' );
...
/* 		register_setting( 'oswp-widget-settings-group', 'oswptitle' );
	...
	public function widget_textdomain() {
		...
		// TODO be sure to change 'oswp-regionsgenerator' to the name of *your* plugin
...
// TODO: Remember to change 'oswp_regionsgenerator' to match the class name definition
//add_action( 'widgets_init', create_function( '', 'register_widget("oswp_regionsgenerator");' ) );

function oswp_regionsgenerator_register_widget() {
register_widget('oswp_regionsgenerator');
}
add_action('widgets_init', 'oswp_regionsgenerator_register_widget');